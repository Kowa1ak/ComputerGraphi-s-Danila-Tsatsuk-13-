...
void letter::getVertexArray(float k){
    ...
    VertexArray[2][0]=1.75*k;
    VertexArray[2][1]=0;
    VertexArray[2][2]=-0.25*k;

    VertexArray[3][0]=1.75*k;
    VertexArray[3][1]=0;
    VertexArray[3][2]=0;
    ...
    VertexArray[10][1]=2*k;
    VertexArray[10][2]=-0.25*k;

    VertexArray[11][0]=0.25*k;
    VertexArray[11][1]=2*k;
    VertexArray[11][2]=0;


    VertexArray[12][0]=0;
    VertexArray[12][1]=0.25*k;
    VertexArray[12][2]=0;

    VertexArray[13][0]=0;
    VertexArray[13][1]=0.25*k;
    VertexArray[13][2]=-0.25*k;

    VertexArray[14][0]=1.75*k;
    VertexArray[14][1]=0.25*k;
    VertexArray[14][2]=-0.25*k;

    VertexArray[15][0]=1.75*k;
    VertexArray[15][1]=0.25*k;
    VertexArray[15][2]=0;
    ...
    VertexArray[17][0]=0;
    VertexArray[17][1]=0.25*k;
    VertexArray[17][2]=0;

    VertexArray[18][0]=1.75*k;
    VertexArray[18][1]=0.25*k;
    VertexArray[18][2]=0;

    VertexArray[19][0]=1.75*k;
    VertexArray[19][1]=0;
    VertexArray[19][2]=0;
    ...
    VertexArray[22][0]=1.75*k;
    VertexArray[22][1]=0.25*k;
    VertexArray[22][2]=-0.25*k;

    VertexArray[23][0]=1.75*k;
    VertexArray[23][1]=0;
    VertexArray[23][2]=-0.25*k;


    VertexArray[24][0]=1.75*k;
    VertexArray[24][1]=0.25*k;
    VertexArray[24][2]=0;

    VertexArray[25][0]=1.75*k;
    VertexArray[25][1]=0.25*k;
    VertexArray[25][2]=-0.25*k;

    VertexArray[26][0]=1.75*k;
    VertexArray[26][1]=-0.5*k;
    VertexArray[26][2]=-0.25*k;

    VertexArray[27][0]=1.75*k;
    VertexArray[27][1]=-0.5*k;
    VertexArray[27][2]=0;


    VertexArray[28][0]=1.75*k;
    VertexArray[28][1]=-0.5*k;
    VertexArray[28][2]=-0.25*k;

    VertexArray[29][0]=1.75*k;
    VertexArray[29][1]=-0.5*k;
    VertexArray[29][2]=0;

    VertexArray[30][0]=1.50*k;
    VertexArray[30][1]=-0.5*k;
    VertexArray[30][2]=0;

    VertexArray[31][0]=1.50*k;
    VertexArray[31][1]=-0.5*k;
    VertexArray[31][2]=-0.25*k;


    VertexArray[32][0]=1.50*k;
    VertexArray[32][1]=0;
    VertexArray[32][2]=0;

    VertexArray[33][0]=1.50*k;
    VertexArray[33][1]=0;
    VertexArray[33][2]=-0.25*k;

    VertexArray[34][0]=1.50*k;
    VertexArray[34][1]=-0.5*k;
    VertexArray[34][2]=-0.25*k;

    VertexArray[35][0]=1.50*k;
    VertexArray[35][1]=-0.5*k;
    VertexArray[35][2]=0;


    VertexArray[36][0]=1.50*k;
    VertexArray[36][1]=-0.5*k;
    VertexArray[36][2]=0;

    VertexArray[37][0]=1.50*k;
    VertexArray[37][1]=0;
    VertexArray[37][2]=0;

    VertexArray[38][0]=1.75*k;
    VertexArray[38][1]=0;
    VertexArray[38][2]=0;

    VertexArray[39][0]=1.75*k;
    VertexArray[39][1]=-0.5*k;
    VertexArray[39][2]=0;


    VertexArray[40][0]=1.75*k;
    VertexArray[40][1]=-0.5*k;
    VertexArray[40][2]=-0.25*k;

    VertexArray[41][0]=1.50*k;
    VertexArray[41][1]=-0.5*k;
    VertexArray[41][2]=-0.25*k;

    VertexArray[42][0]=1.50*k;
    VertexArray[42][1]=0;
    VertexArray[42][2]=-0.25*k;

    VertexArray[43][0]=1.75*k;
    VertexArray[43][1]=0;
    VertexArray[43][2]=-0.25*k;


    VertexArray[44][0]=0.25*k;
    VertexArray[44][1]=0.25*k;
    VertexArray[44][2]=0;

    VertexArray[45][0]=0;
    VertexArray[45][1]=0.25*k;
    VertexArray[45][2]=0;

    VertexArray[46][0]=0;
    VertexArray[46][1]=2*k;
    VertexArray[46][2]=0;

    VertexArray[47][0]=0.25*k;
    VertexArray[47][1]=2*k;
    VertexArray[47][2]=0;


    VertexArray[48][0]=0;
    VertexArray[48][1]=2*k;
    VertexArray[48][2]=-0.25*k;

    VertexArray[49][0]=0.25*k;
    VertexArray[49][1]=2*k;
    VertexArray[49][2]=-0.25*k;

    VertexArray[50][0]=0.25*k;
    VertexArray[50][1]=0.25*k;
    VertexArray[50][2]=-0.25*k;

    VertexArray[51][0]=0;
    VertexArray[51][1]=0.25*k;
    VertexArray[51][2]=-0.25*k;


    VertexArray[52][0]=0.25*k;
    VertexArray[52][1]=0.25*k;
    VertexArray[52][2]=0;

    VertexArray[53][0]=0.25*k;
    VertexArray[53][1]=0.25*k;
    VertexArray[53][2]=-0.25*k;

    VertexArray[54][0]=0.25*k;
    VertexArray[54][1]=2*k;
    VertexArray[54][2]=-0.25*k;

    VertexArray[55][0]=0.25*k;
    VertexArray[55][1]=2*k;
    VertexArray[55][2]=0;
    ...
    VertexArray[57][0]=1*k;
    VertexArray[57][1]=0.25*k;
    VertexArray[57][2]=0;

    VertexArray[58][0]=1*k;
    VertexArray[58][1]=2*k;
    VertexArray[58][2]=0;

    VertexArray[59][0]=1.25*k;
    VertexArray[59][1]=2*k;
    VertexArray[59][2]=0;
    ...
    VertexArray[63][0]=1*k;
    VertexArray[63][1]=2*k;
    VertexArray[63][2]=-0.25*k;


    VertexArray[64][0]=1*k;
    VertexArray[64][1]=0.25*k;
    VertexArray[64][2]=-0.25*k;

    VertexArray[65][0]=1.25*k;
    VertexArray[65][1]=0.25*k;
    VertexArray[65][2]=-0.25*k;

    VertexArray[66][0]=1.25*k;
    VertexArray[66][1]=2*k;
    VertexArray[66][2]=-0.25*k;

    VertexArray[67][0]=1*k;
    VertexArray[67][1]=2*k;
    VertexArray[67][2]=-0.25*k;


    VertexArray[68][0]=1.25*k;
    VertexArray[68][1]=0.25*k;
    VertexArray[68][2]=0;

    VertexArray[69][0]=1.25*k;
    VertexArray[69][1]=0.25*k;
    ...
    VertexArray[71][1]=2*k;
    VertexArray[71][2]=0;


    VertexArray[72][0]=1*k;
    VertexArray[72][1]=0.25*k;
    VertexArray[72][2]=0;

    VertexArray[73][0]=1*k;
    VertexArray[73][1]=0.25*k;
    VertexArray[73][2]=-0.25*k;

    VertexArray[74][0]=1*k;
    VertexArray[74][1]=2*k;
    VertexArray[74][2]=-0.25*k;

    VertexArray[75][0]=1*k;
    VertexArray[75][1]=2*k;
    VertexArray[75][2]=0;
